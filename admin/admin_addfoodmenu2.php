...
<br></br>
  ...
  <div class="w3-container" style="margin-top:75px">
	...
	if (is_numeric($_POST['category'])) {
       	...
       	$query = "INSERT INTO menu (id, name, price_1, price_2, category) VALUES ('','$name','$price','$price2','$category')";
  ...
  <input type="hidden" name="MAX_FILE_SIZE" value="524288">
    ...
    <h1 align="left" class="w3-large w3-text-grey"><b>Add Menu</b></h1>
      ...
      <tr><td style="padding-bottom: 10px;"><b> Price(hot): </b><input type="text" name="price" size="25" maxlength="60" required></td></tr>
      <tr><td style="padding-bottom: 10px;"><b> Price(cold): </b><input type="text" name="price2" size="25" maxlength="60" required></td></tr>
