...
<body>
	...
	<table align="left">
	<form action="process_edit_menu2.php" method="post">
	<tr>
	...
	<tr>
	<td style="font-weight: bold; padding-bottom: 10px" align="right"> Price (Hot) </td>
	<td style="padding-bottom: 10px">
	<input type="text" name="price1" value="<?php echo $record['price_1']?>" />
	</td></tr>
	<tr>
	<td style="font-weight: bold; padding-bottom: 10px" align="right"> Price (Cold) </td>
	<td style="padding-bottom: 10px">
	<input type="text" name="price2" value="<?php echo $record['price_2']?>" />
	</td></tr>
	<tr>
	<td>&nbsp;</td>
	<td style="padding-bottom: 10px">
