...
$errors = array(); // Initialize error array.
	...
	<br /><br /><b> Name  : </b>$n
	<br /><br /><b>Price: </b>$price<br />";
	
	require_once ('mysql_connect.php');
			$query = "INSERT INTO delivery_prod (description, name, price) VALUES ('$desc', '$n', '$price')";
			$result = mysqli_query($dbc, $query);
				if ($result) { // If it ran OK.
				
					
					// Print a message.
					echo '<p><b>Reservation confirmed</b></p>';				
  ...
  <input type="hidden" name="MAX_FILE_SIZE" value="524288">
    ...
    <h1 align="left" class="w3-large w3-text-grey"><b>Add Product</b></h1>
    <table align="left">
      <tr><td style="padding-bottom: 10px;"><b> Name: </b> <input type="text" name="name" size="25" maxlength="60"  /></td></tr>
      <tr><td style="padding-bottom: 10px;"><b> Price  </b> <input type="file" name="image" /></td></tr>
