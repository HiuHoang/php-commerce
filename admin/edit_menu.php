...
$sql = "select * from `delivery_prod` WHERE id = $id";
...
<body>
	...
	<table align="left">
	<form enctype="multipart/form-data" action="process_edit_menu.php" method="post">
 ...
 <tr>
  <td style="font-weight: bold; padding-bottom: 10px" align="right">Description</td>
  <td style="padding-bottom: 10px">
  <input type="textarea" name="description" value="<?php echo $record['description']?>" />
</td></tr>
  <tr>
...
<td style="font-weight: bold; padding-bottom: 10px" align="right"> Image </td>
<td style="padding-bottom: 10px">
...
<tr>
	...
	<input type="hidden" name="imagebu" value="<?php echo $record['image']; ?>">
  </td></tr>
</form>
</table>
</body>
